...
link:https://github.com/google/grr/tree/master/artifacts[The collection of
...
link:https://github.com/google/grr/blob/master/proto/knowledge_base.proto[proto/knowledge_base.proto])
...
New artifacts can be added to the link:https://github.com/google/grr/tree/master/artifacts[grr/artifacts] directory, which will be
